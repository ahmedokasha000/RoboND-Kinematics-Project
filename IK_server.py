...
#initializing parameters ,matrices that we will only use once
def init_parameters():
    start = time.time()
    #Declaring Joints Parameters
    global r, p, y   
...
def handle_calculate_IK(req):
    global q1, q2, q3, q4, q5, q6, q7
    global T0_1,T1_2,T2_3,R0_3,T0_7,Rrpy0
    global r, p, y
    ...
    if len(req.poses) < 1:
	    ...
	    # Calculate joint angles using Geometric IK method
            ...
            #Forward_Kinematic=T_final.evlaf(subs={'q1': theta1, 'q2': theta2, 'q3': theta3,'q4': theta4, 'q5': theta5, 'q6': theta6})
